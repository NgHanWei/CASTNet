...
from gpt2 import TransformerBlock
...
def ATCNet(n_classes, in_chans = 22, in_samples = 1125, n_windows = 3, attention = None, 
           eegn_F1 = 16, eegn_D = 2, eegn_kernelSize = 64, eegn_poolSize = 8, eegn_dropout=0.4, 
           tcn_depth = 2, tcn_kernelSize = 4, tcn_filters = 32, tcn_dropout = 0.4, 
    ...
    # transformer_block = TransformerBlock(tcn_filters, 2, tcn_filters)
    # block1 = transformer_block(block1)
    ...
    for i in range(n_windows):
        ...
        # transformer_block = TransformerBlock(tcn_filters, 4, tcn_filters) #4 is the default
        # block2 = transformer_block(block2)
